...
ElderGroup:
    ...
    ; party
    dbp 27, NOCTOWL,
		db WIDE_LENS, ABILITY_1 | NAT_NEUTRAL, MALE
    	db HYPNOSIS, ZEN_HEADBUTT, HEX, ROOST
    dbp 27, HAUNTER,
		db EVIOLITE, ABIL_HAUNTER_LEVITATE | NAT_NEUTRAL, MALE
    	db PAIN_SPLIT, SHADOW_BALL, SUCKER_PUNCH,  CONFUSE_RAY
    dbp 30, VICTREEBEL,
		db MIRACLE_SEED, ABILITY_1 | NAT_NEUTRAL, FEMALE
...
; ================
    ...
    ; party
    dbp 23, SCYTHER,
		db SILVERPOWDER, ABIL_SCYTHER_TECHNICIAN | NAT_SPD_UP_SATK_DOWN, MALE
    	db U_TURN, CUT, GLARE, AERIAL_ACE
    dbp 24, KABUTOPS,
		db QUICK_CLAW, ABIL_KABUTOPS_WEAK_ARMOR | NAT_DEF_UP_SATK_DOWN, MALE
    	db CUT, AERIAL_ACE, ROCK_SLIDE, HONE_CLAWS
    dbp 23, SNEASEL,
		db NO_ITEM, ABIL_SNEASEL_PICKPOCKET | NAT_NEUTRAL, MALE
    	db CUT, HEALINGLIGHT, FEINT_ATTACK, HONE_CLAWS
    dbp 24, PINSIR,
		db SILVERPOWDER, ABIL_PINSIR_MOXIE | NAT_ATK_UP_SATK_DOWN, MALE
    	db CUT, X_SCISSOR, SWORDS_DANCE, ROCK_SLIDE
    dbp 25, FARFETCH_D,
		db LEEK, ABIL_FARFETCH_D_DEFIANT | NAT_SPD_UP_SATK_DOWN, MALE
