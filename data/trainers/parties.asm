...
PokefanFGroup:
    ...
    dbp 38, LEDIAN
		db LIGHT_CLAY, ABIL_LEDIAN_IRON_FIST | NAT_DEF_UP_SATK_DOWN, FEMALE, "LadyPunch@"
    	db MACH_PUNCH, BUG_BUZZ, ICE_PUNCH, REFLECT
    dbp 37, HERACROSS
		db ASSAULT_VEST, ABILITY_1 | NAT_SATK_UP_ATK_DOWN, FEMALE, "BeatleBee@"
    	db MEGAHORN, CLOSE_COMBAT, AERIAL_ACE, ENDURE
    dbp 38, GRANBULL
		db WEAK_POLICY, ABILITY_1 | NAT_SPD_UP_SATK_DOWN, FEMALE, "GranGran@"
    	db PLAY_ROUGH, BITE, CHARM, PROTECT
    dbp 37, POLITOED
		db DAMP_ROCK, ABIL_POLITOED_DRIZZLE | NAT_NEUTRAL, MALE, "Drizz@"
    	db GIGA_DRAIN, BUBBLE_BEAM, TOXIC, PROTECT
    dbp 39, DONPHAN
		db QUICK_CLAW, ABILITY_1 | NAT_SPD_UP_SATK_DOWN, FEMALE, "Ellie@"
    	db EARTHQUAKE, RAPID_SPIN, SEED_BOMB, RAPID_SPIN
    dbp 40, SHUCKLE
		db LEFTOVERS, ABIL_SHUCKLE_CONTRARY | NAT_NEUTRAL, MALE, "Shuck@"
...
SuperNerdGroup:
    ...
    ; party
    dbp 31, PIDGEOTTO
		db SHARP_BEAK, 16, ABIL_PIDGEOTTO_BIG_PECKS | NAT_NEUTRAL, MALE
    	db GUST, MUD_SLAP, QUICK_ATTACK, ROOST
	dbp 32, SCYTHER
		db SITRUS_BERRY, 32, ABILITY_1 | NAT_NEUTRAL, MALE
    	db QUICK_ATTACK, LEER, PURSUIT, U_TURN
	dbp 33, MILTANK
		db LUM_BERRY, 48, ABIL_MILTANK_SCRAPPY | NAT_NEUTRAL, FEMALE
    	db DEFENSE_CURL, STOMP, FRESH_SNACK, ROLLOUT
	dbp 34, GENGAR
		db WIDE_LENS, 64, ABIL_GENGAR_LEVITATE | NAT_NEUTRAL, MALE
    	db HYPNOSIS, THUNDERBOLT, SHADOW_BALL, DREAM_EATER
	dbp 35, POLIWRATH
		db ZOOM_LENS, 80, ABIL_POLIWRATH_DAMP | NAT_NEUTRAL, MALE
    	db HYPNOSIS, THUNDERBOLT, SHADOW_BALL, DREAM_EATER
    db -1 ; end
...
GentlemanGroup:
    ...
    ; party
    dbp 32, MILTANK
		db LEFTOVERS, ABIL_MILTANK_SCRAPPY | NAT_SPD_UP_SDEF_DOWN, MALE
    	db FRESH_SNACK, SURF, BODY_SLAM, ZEN_HEADBUTT
    dbp 32, NIDOKING
		db LEFTOVERS, ABILITY_1 | NAT_NEUTRAL, MALE
    	db SURF, BULLDOZE, SWEET_KISS, SHADOW_CLAW
    dbp 32, TAUROS
		db WEAK_POLICY, ABIL_TAUROS_ANGER_POINT | NAT_SPD_UP_SATK_DOWN, MALE
    	db SURF, ZEN_HEADBUTT, THRASH, SWAGGER
    dbp 31, TYRANITAR
		db ASSAULT_VEST, ABILITY_1 | NAT_NEUTRAL, MALE
    	db SURF, BITE, ROCK_SLIDE, BRICK_BREAK
    dbp 33, RHYDON
		db ASSAULT_VEST, ABILITY_1 | NAT_SATK_UP_DEF_DOWN, MALE
