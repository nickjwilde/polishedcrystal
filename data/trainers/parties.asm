...
PokefanFGroup:
    ...
    dbp 38, LEDIAN, FEMALE
		db LIGHT_CLAY, ABIL_LEDIAN_IRON_FIST | NAT_DEF_UP_SATK_DOWN, "LadyPunch@"
    	db MACH_PUNCH, BUG_BUZZ, ICE_PUNCH, REFLECT
    dbp 37, HERACROSS, FEMALE
		db ASSAULT_VEST, ABILITY_1 | NAT_SATK_UP_ATK_DOWN, "BeatleBee@"
    	db MEGAHORN, CLOSE_COMBAT, AERIAL_ACE, ENDURE
    dbp 38, GRANBULL, FEMALE
		db WEAK_POLICY, ABILITY_1 | NAT_SPD_UP_SATK_DOWN, "GranGran@"
    	db PLAY_ROUGH, BITE, CHARM, PROTECT
    dbp 37, POLITOED, MALE
		db DAMP_ROCK, ABIL_POLITOED_DRIZZLE | NAT_NEUTRAL, "Drizz@"
    	db GIGA_DRAIN, BUBBLE_BEAM, TOXIC, PROTECT
    dbp 39, DONPHAN, FEMALE
		db QUICK_CLAW, ABILITY_1 | NAT_SPD_UP_SATK_DOWN, "Ellie@"
    	db EARTHQUAKE, RAPID_SPIN, SEED_BOMB, RAPID_SPIN
    dbp 40, SHUCKLE, MALE
		db LEFTOVERS, ABIL_SHUCKLE_CONTRARY | NAT_NEUTRAL, "Shuck@"
...
SuperNerdGroup:
    ...
    db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES 
    ; party
    dbp 31, PIDGEOTTO, MALE
		db SHARP_BEAK, 16, ABIL_PIDGEOTTO_BIG_PECKS | NAT_NEUTRAL
    	db GUST, MUD_SLAP, QUICK_ATTACK, ROOST
	dbp 32, SCYTHER, MALE
		db SITRUS_BERRY, 32, ABILITY_1 | NAT_NEUTRAL
    	db QUICK_ATTACK, LEER, PURSUIT, U_TURN
	dbp 33, MILTANK, FEMALE
		db LUM_BERRY, 48, ABIL_MILTANK_SCRAPPY | NAT_NEUTRAL
    	db DEFENSE_CURL, STOMP, FRESH_SNACK, ROLLOUT
	dbp 34, GENGAR, MALE
		db WIDE_LENS, 64, ABIL_GENGAR_LEVITATE | NAT_NEUTRAL
    	db HYPNOSIS, THUNDERBOLT, SHADOW_BALL, DREAM_EATER
	dbp 35, POLIWRATH, MALE
		db ZOOM_LENS, 80, ABIL_POLIWRATH_DAMP | NAT_NEUTRAL
    	db HYPNOSIS, THUNDERBOLT, SHADOW_BALL, DREAM_EATER
    db -1 ; end
...
GentlemanGroup:
    ...
    ; party
    dbp 32, MILTANK, MALE
		db LEFTOVERS, ABIL_MILTANK_SCRAPPY | NAT_SPD_UP_SDEF_DOWN
    	db FRESH_SNACK, SURF, BODY_SLAM, ZEN_HEADBUTT
    dbp 32, NIDOKING, MALE
		db LEFTOVERS, ABILITY_1 | NAT_NEUTRAL
    	db SURF, BULLDOZE, SWEET_KISS, SHADOW_CLAW
    dbp 32, TAUROS, MALE
		db WEAK_POLICY, ABIL_TAUROS_ANGER_POINT | NAT_SPD_UP_SATK_DOWN
    	db SURF, ZEN_HEADBUTT, THRASH, SWAGGER
    dbp 31, TYRANITAR, MALE
		db ASSAULT_VEST, ABILITY_1 | NAT_NEUTRAL
    	db SURF, BITE, ROCK_SLIDE, BRICK_BREAK
    dbp 33, RHYDON, MALE
		db ASSAULT_VEST, ABILITY_1 | NAT_SATK_UP_DEF_DOWN
...
; ================
    ...
    ; party
    dbp 23, SCYTHER, MALE
		db SILVERPOWDER, ABIL_SCYTHER_TECHNICIAN | NAT_SPD_UP_SATK_DOWN
    	db U_TURN, CUT, GLARE, AERIAL_ACE
    dbp 24, KABUTOPS, MALE
		db QUICK_CLAW, ABIL_KABUTOPS_WEAK_ARMOR | NAT_DEF_UP_SATK_DOWN
    	db CUT, AERIAL_ACE, ROCK_SLIDE, HONE_CLAWS
    dbp 23, SNEASEL, MALE
		db NO_ITEM, ABIL_SNEASEL_PICKPOCKET | NAT_NEUTRAL
    	db CUT, HEALINGLIGHT, FEINT_ATTACK, HONE_CLAWS
    dbp 24, PINSIR, MALE
		db SILVERPOWDER, ABIL_PINSIR_MOXIE | NAT_ATK_UP_SATK_DOWN
    	db CUT, X_SCISSOR, SWORDS_DANCE, ROCK_SLIDE
    dbp 25, FARFETCH_D , MALE
		db LEEK, ABIL_FARFETCH_D_DEFIANT | NAT_SPD_UP_SATK_DOWN
