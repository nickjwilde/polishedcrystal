...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_MOVES
	; party
	db 78, ELECTIVIRE, BLACK_BELT, FAKE_PERFECT_DVS
		db CROSS_CHOP, THUNDERPUNCH, LIGHT_SCREEN, WILD_CHARGE
	db 76, ELECTRODE, SILK_SCARF, FAKE_PERFECT_DVS
		db REFLECT, DOUBLE_TEAM, SWIFT, EXPLOSION
	db 77, JOLTEON, NEVERMELTICE, DVS_HP_ICE
		db HIDDEN_POWER, THUNDER_WAVE, HYPER_VOICE, THUNDERBOLT
	db 76, MAGNEZONE, CHARCOAL, DVS_HP_FIRE
		db LIGHT_SCREEN, DOUBLE_TEAM, HIDDEN_POWER, THUNDERBOLT
	db 77, LANTURN, LEFTOVERS, FAKE_PERFECT_DVS
		db SURF, ICE_BEAM, THUNDERBOLT, RECOVER
	db 79, RAICHU, BRIGHTPOWDER, FAKE_PERFECT_DVS
...
; ================
	...
	db 73, RAPIDASH, SITRUS_BERRY, 240
...
endc
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_MOVES
	; party
	db 82, UMBREON, BRIGHTPOWDER
		db CONFUSE_RAY, TOXIC, FEINT_ATTACK, PROTECT
	db 81, MACHAMP, BLACK_BELT
		db CROSS_CHOP, EARTHQUAKE, STONE_EDGE, THUNDERPUNCH
	db 82, KABUTOPS, HARD_STONE
		db SLASH, SURF, STONE_EDGE, GIGA_DRAIN
	db 82, EXEGGUTOR, MIRACLE_SEED
		db PSYCHIC_M, LEECH_SEED, SEED_BOMB, GIGA_DRAIN
	db 82, ARCANINE, CHARCOAL
		db ROAR, OUTRAGE, FLARE_BLITZ, EXTREMESPEED
	db 83, BLASTOISE, LEFTOVERS
...
; ================
    ...
    db 38, LEDIAN, LIGHT_CLAY, ABIL_LEDIAN_IRON_FIST | NAT_DEF_UP_SATK_DOWN, FEMALE, "LadyPunch@"
    db MACH_PUNCH, BUG_BUZZ, ICE_PUNCH, REFLECT
    db 37, HERACROSS, ASSAULT_VEST, ABILITY_1 | NAT_SATK_UP_ATK_DOWN, FEMALE, "BeatleBee@"
    db MEGAHORN, CLOSE_COMBAT, AERIAL_ACE, ENDURE
    db 38, GRANBULL, WEAK_POLICY, ABILITY_1 | NAT_SPD_UP_SATK_DOWN, FEMALE, "GranGran@"
    db PLAY_ROUGH, BITE, CHARM, PROTECT
    db 37, POLITOED, DAMP_ROCK, ABIL_POLITOED_DRIZZLE | NAT_NEUTRAL, MALE, "Drizz@"
    db GIGA_DRAIN, BUBBLE_BEAM, TOXIC, PROTECT
    db 39, DONPHAN, QUICK_CLAW, ABILITY_1 | NAT_SPD_UP_SATK_DOWN, FEMALE, "Ellie@"
    db EARTHQUAKE, RAPID_SPIN, SEED_BOMB, RAPID_SPIN
    db 40, SHUCKLE, LEFTOVERS, ABIL_SHUCKLE_CONTRARY | NAT_NEUTRAL, MALE, "Shuck@"
    db TOXIC, PROTECT, ROCK_SLIDE, ENDURE
    db -1 ; end
...
; ================
    ...
    db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES 
    ; party
    db 31, PIDGEOTTO, SHARP_BEAK, 16, ABIL_PIDGEOTTO_BIG_PECKS | NAT_NEUTRAL, MALE
    db GUST, MUD_SLAP, QUICK_ATTACK, ROOST
	db 32, SCYTHER, SITRUS_BERRY, 32, ABILITY_1 | NAT_NEUTRAL, MALE
    db QUICK_ATTACK, LEER, PURSUIT, U_TURN
	db 33, MILTANK, LUM_BERRY, 48, ABIL_MILTANK_SCRAPPY | NAT_NEUTRAL, FEMALE
    db DEFENSE_CURL, STOMP, FRESH_SNACK, ROLLOUT
	db 34, GENGAR, WIDE_LENS, 64, ABIL_GENGAR_LEVITATE | NAT_NEUTRAL, MALE
    db HYPNOSIS, THUNDERBOLT, SHADOW_BALL, DREAM_EATER
	db 35, POLIWRATH, ZOOM_LENS, 80, ABIL_POLIWRATH_DAMP | NAT_NEUTRAL, MALE
    db HYPNOSIS, THUNDERBOLT, SHADOW_BALL, DREAM_EATER
    db -1 ; end
...
; ================
    ...
    db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
    ; party
    db 27, NOCTOWL, WIDE_LENS, ABILITY_1 | NAT_NEUTRAL, MALE
    db HYPNOSIS, ZEN_HEADBUTT, HEX, ROOST
    db 27, HAUNTER, EVIOLITE, ABIL_HAUNTER_LEVITATE | NAT_NEUTRAL, MALE
    db PAIN_SPLIT, SHADOW_BALL, SUCKER_PUNCH,  CONFUSE_RAY
    db 30, VICTREEBEL, MIRACLE_SEED, ABILITY_1 | NAT_NEUTRAL, FEMALE
    db HEALINGLIGHT, POISON_JAB, RAZOR_LEAF, SWORDS_DANCE
    db -1 ; end
; ================
...
; ================
    ...
    db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
    ; party
    db 32, MILTANK, LEFTOVERS, ABIL_MILTANK_SCRAPPY | NAT_SPD_UP_SDEF_DOWN, MALE
    db FRESH_SNACK, SURF, BODY_SLAM, ZEN_HEADBUTT
    db 32, NIDOKING, LEFTOVERS, ABILITY_1 | NAT_NEUTRAL, MALE
    db SURF, BULLDOZE, SWEET_KISS, SHADOW_CLAW
    db 32, TAUROS, WEAK_POLICY, ABIL_TAUROS_ANGER_POINT | NAT_SPD_UP_SATK_DOWN, MALE
    db SURF, ZEN_HEADBUTT, THRASH, SWAGGER
    db 31, TYRANITAR, ASSAULT_VEST, ABILITY_1 | NAT_NEUTRAL, MALE
    db SURF, BITE, ROCK_SLIDE, BRICK_BREAK
    db 33, RHYDON, ASSAULT_VEST, ABILITY_1 | NAT_SATK_UP_DEF_DOWN, MALE
    db SURF, DOUBLE_EDGE, BULLDOZE, STONE_EDGE
    db -1 ; end
...
; ================
    ...
    db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
    ; party
    db 23, SCYTHER, SILVERPOWDER, ABIL_SCYTHER_TECHNICIAN | NAT_SPD_UP_SATK_DOWN, MALE
    db U_TURN, CUT, GLARE, AERIAL_ACE
    db 24, KABUTOPS, QUICK_CLAW, ABIL_KABUTOPS_WEAK_ARMOR | NAT_DEF_UP_SATK_DOWN, MALE
    db CUT, AERIAL_ACE, ROCK_SLIDE, HONE_CLAWS
    db 23, SNEASEL, NO_ITEM, ABIL_SNEASEL_PICKPOCKET | NAT_NEUTRAL, MALE
    db CUT, HEALINGLIGHT, FEINT_ATTACK, HONE_CLAWS
    db 24, PINSIR, SILVERPOWDER, ABIL_PINSIR_MOXIE | NAT_ATK_UP_SATK_DOWN, MALE
    db CUT, X_SCISSOR, SWORDS_DANCE, ROCK_SLIDE
    db 25, FARFETCH_D, STICK, ABIL_FARFETCH_D_DEFIANT | NAT_SPD_UP_SATK_DOWN, MALE
    db CUT, AERIAL_ACE, KARATE_CHOP, ROOST
    db -1 ; end
...
; ================
    ...
    ; party
    db 34, PRIMEAPE
    db BRICK_BREAK, THRASH, FEINT_ATTACK, SEISMIC_TOSS
    db 33, POLIWRATH
    db BRICK_BREAK, AQUA_JET, BODY_SLAM, SWEET_KISS
    db 32, MACHOKE
    db BRICK_BREAK, SEISMIC_TOSS, THRASH, BULK_UP
    db 34, HITMONCHAN
    db BRICK_BREAK, DIZZY_PUNCH, ICE_PUNCH, THUNDERPUNCH
    db -1 ; end
