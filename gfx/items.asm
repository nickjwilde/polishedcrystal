...
HeadlampIcon::     INCBIN "gfx/items/headlamp.2bpp.lz"
GiantPlugIcon::    INCBIN "gfx/items/giant_plug.2bpp.lz"
JetpackIcon::      INCBIN "gfx/items/jetpack.2bpp.lz"
RockHammerIcon::   INCBIN "gfx/items/rock_hammer.2bpp.lz"
TabletIcon::       INCBIN "gfx/items/tablet.2bpp.lz"
