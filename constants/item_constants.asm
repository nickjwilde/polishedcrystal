...
; - KeyItemEffects (see engine/items/item_effects.asm)
    ...
    const POKEWALKER   ; 20
    const KATANA       ; 21 Cut
    const JETSKI       ; 22 Surf
    const PWR_BRACE    ; 23 Strength
    const SACREDLAMP   ; 24 Flash
    const GIANT_PLUG   ; 25 Whirlpool
    const JETPACK      ; 26 Waterfall
    const ROCK_HAMMER  ; 27 Rock Smash
    const TABLET       ; 28
