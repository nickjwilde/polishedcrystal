...
; Cut trees
    ...
    const EVENT_GOT_SACREDLAMP
    const EVENT_GOT_KATANA
    const EVENT_GOT_JETSKI
    const EVENT_GOT_PWR_BRACE
    const EVENT_GOT_GIANT_PLUG
    const EVENT_GOT_JETPACK
    const EVENT_GOT_ROCK_HAMMER

; TODO: rearrange
	const VENT_MAGNET_TUNNEL_HIDDEN_METAL_POWDER
	...
	const_next $906
DEF NUM_EVENTS EQU const_value ; 2310
